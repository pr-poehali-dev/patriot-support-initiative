      ...
      <div className="sec bg-r">
        <div className="c">
          ...
          <div className="xg" style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 24 }}>
            {[
              { bg: "linear-gradient(135deg,#1A1A2E,#16213E)", emoji: "🎖", title: "Ветераны Приморья — вместе с молодёжью", desc: "Регулярные встречи, где ветераны передают живую историю — не по учебнику, а лично. Студенты и школьники слушают, задают вопросы и остаются помогать.", quote: "«Когда слышишь это от живого человека — это совсем другое.»" },
