...
const ITEMS: Item[] = [
  ...
  },
  {
    ...
    title: "Мастер-класс по изготовлению тактических браслетов",
    text: "Директор АНО \"ПАТРИОТ ДВ\" Алексей Михайленко провёл мастер-класс по изготовлению тактических браслетов с коллективом добровольных помощников \"Мама Ира и руки ангелов\" (руководитель Ирина Перфилова).",
    stats: [],
    url: "https://vk.com/video_ext.php?oid=893941164&id=456239062&hash=4939b9ac9321603e",
  },
  {
    type: "photo",
  ...
  },
  {
    ...
    title: "Неравнодушные сердца: ветераны Артёма поддерживают участников СВО",
    text: "Артём – город неравнодушных людей, которые готовы прийти на помощь в трудную минуту. Среди них – люди, которые, несмотря на свой пенсионный возраст, активно участвуют в поддержке защитников Родины.\n\nЧлены Совета ветеранов в Артёме плетут маскировочные сети и костюмы для снайперов, вяжут носки и собирают гуманитарную помощь.",
    stats: [],
    url: "https://vk.com/video_ext.php?oid=-210960501&id=456239286&hash=06691de22dd2fc3f",
  },
  {
    type: "photo",
  ...
  {
    type: "video",
    date: "Апрель 2026 · Станица Аркуда",
    title: "Обучение школьников плетению тактических браслетов на казачьей станице Аркуда",
    text: "По приглашению Андрея Кондратова, атамана станицы Аркуда, ветерана СВО, провели мероприятие, приуроченное грядущей 81-ой годовщине Великой Победы.\n\nНа территории казачьей станицы Аркуда провели обучение школьников плетению тактических браслетов.\n\nИз личного опыта добровольца Барс, в составе отряда «Тигр» Максима Пьянкова, с позывным «Шрек», можно с уверенностью сказать: браслет выживания – это не просто аксессуар, а многофункциональный инструмент, способный кардинально изменить ход событий в критической ситуации.\n\nБраслет изготовлен из особо прочной нити «ПАРАКОРД» с максимальной прочностью на разрыв 370 кг. Длина каждого изделия 4 метра.",
    stats: [],
    url: "https://vk.com/video_ext.php?oid=893941164&id=456239061&hash=d1b36eee41403775",
  },
];
